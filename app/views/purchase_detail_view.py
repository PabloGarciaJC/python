...
class PurchaseDetailView:
        ...
        if details:
            for idx, detail in enumerate(details, 1):
                ...
                <tr>
                    ...
                    <td>
                        <a href="/detalle-compras/{detail['id']}/ver/" class="btn" style="background: #3b82f6; color: white; padding: 8px 15px; font-size: 13px;">Ver</a>
                        <a href="/detalle-compras/{detail['id']}/editar/" class="btn btn-warning">Editar</a>
                        <form method="POST" action="/detalle-compras/{detail['id']}/eliminar/" style="display: inline;">
                            {csrf_token}
    ...
    def create(user, purchases, products, request, error=None):
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="/detalle-compras/" class="btn" style="background: #6b7280; color: white;">← Volver</a>
            </div>
            {error_html}
            <form method="POST" action="/detalle-compras/crear/" style="padding: 20px;" id="detailForm">
                {csrf_token}
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    <div>
                        <label style="display: block; margin-bottom: 5px; font-weight: 600; color: #333;">Compra *</label>
                ...
                <div style="margin-top: 30px; display: flex; gap: 10px; justify-content: flex-end;">
                    <a href="/detalle-compras/" class="btn" style="background: #6b7280; color: white;">Cancelar</a>
    ...
    def edit(user, detail, products, request, error=None):
        ...
        <div class="card">
            ...
            {error_html}
            <form method="POST" action="/detalle-compras/{detail['id']}/editar/" style="padding: 20px;" id="detailForm">
                {csrf_token}
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    <div>
                        <label style="display: block; margin-bottom: 5px; font-weight: 600; color: #333;">Compra</label>
                        ...
                        <small style="color: #666;">La compra no se puede cambiar</small>
                    </div>
        ...
        <div class="card">
            ...
            <div style="padding: 20px;">
                <div style="background: #f9fafb; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
                    <h3 style="margin: 0 0 15px 0; color: #111827; font-size: 18px;">Información de la Compra</h3>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px;">
                        ...
                        <div>
                            <p style="margin: 0; color: #6b7280; font-size: 13px;">Proveedor</p>
                            <p style="margin: 5px 0 0 0; font-weight: 600; color: #111827;">{detail['proveedor_nombre']}</p>
                        </div>
                        <div>
                            <p style="margin: 0; color: #6b7280; font-size: 13px;">Fecha</p>
                            <p style="margin: 5px 0 0 0; font-weight: 600; color: #111827;">{detail['fecha_compra']}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            <p style="margin: 0; color: #6b7280; font-size: 13px;">Total Compra</p>
                            <p style="margin: 5px 0 0 0; font-weight: 600; color: #059669; font-size: 18px;">S/ {detail['compra_total']:.2f}</p>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-top: 30px; display: flex; gap: 10px;">
                    ...
                    <a href="/detalle-compras/" class="btn" style="background: #6b7280; color: white;">Volver al Listado</a>
                </div>
            </div>
        </div>
        """
